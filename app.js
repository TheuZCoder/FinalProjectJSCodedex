...
function update() {
    if (cursors.space.isDown && !isGameStarted) {
        isGameStarted = true;
        messageToPlayer.text = 'INSTRUÇÕES: APERTE ESPAÇO PARA COMEÇAR\nE NÃO\'BATA NOS OBSTACULOS';
    }
    ...
    if (hasLanded || hasBumped) {
        messageToPlayer.text = 'Você bateu!!!!!'
    }

    if (bird.x > 750) {
        bird.setVelocityY(40);
        messageToPlayer.text = 'PARABENS!!!! VOCÊ CHEGOU AO FINAL DO JOGO!!!!'
    }
}